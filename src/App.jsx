...
//           </h2>
//           <p style={{ color: 'rgba(255,255,255,0.75)', fontSize: '0.82rem', marginTop: 6, lineHeight: 1.5 }}>
...
//             <span>
//               Kami sudah mengisi <strong>data contoh</strong> agar kamu bisa langsung
//               melihat tampilan aplikasi.
//             </span>
//           </div>

//           <p style={{ fontWeight: 600, fontSize: '0.9rem', marginBottom: 14, color: 'var(--text)' }}>
//             Apakah data contoh ingin dihapus?
//           </p>

//           <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
//             <button className="btn btn-danger btn-lg w-full" onClick={onClear}>
//               🗑️ &nbsp;Hapus — mulai dari nol
//             </button>
//             <button className="btn btn-ghost btn-lg w-full" onClick={onKeep}>
//               ✅ &nbsp;Simpan — lihat dulu contohnya
//             </button>
//           </div>
//         </div>
...
//           textAlign: 'center',
//         }}>
//           <p style={{ fontSize: '0.73rem', color: 'var(--text3)', margin: 0 }}>
//             Data contoh bisa dihapus kapan saja lewat menu <strong>Pengaturan</strong>.
//           </p>
//         </div>
//       </div>
//     </div>
...
//   const handleKeepDummy = () => {
//     clearFirstLogin();
//   };

//   const handleClearDummy = () => {
//     resetData(user.username);
//     data.setTransaksi([]);
//     data.setTagihan([]);
//     data.setPiutang([]);
//     data.setHutang([]);
...
//         <WelcomeModal
//           user={user}
//           onKeep={handleKeepDummy}
//           onClear={handleClearDummy}
//         />
//       )}
...
function AppShell({ user, logout, changePassword, updateName, resetData, clearFirstLogin }) {
  ...
  const handleClearDummy = () => {
    resetData(user.username);
    data.setTransaksi([]); data.setTagihan([]); data.setPiutang([]);
    data.setHutang([]); data.setAset([]); data.setSaldoAwal(0);
    data.setWifiIsp([]); data.setWifiBayar([]); data.setBudget([]);
    clearFirstLogin();
  };
